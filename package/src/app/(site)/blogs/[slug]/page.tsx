            ...
            <>
                ...
                <section className="pt-12!">
                    <div className="container max-w-8xl mx-auto px-4">
                        ...
                        {/* Author Contact Info */}
                        {(post.authorEmail || post.authorLinkedIn) && (
                            <div className="mt-12 flex flex-col items-center justify-center border-t pt-8">
                                <h4 className="text-lg font-semibold mb-2 text-dark dark:text-white">Contact the Author</h4>
                                <div className="flex flex-col items-center gap-2">
                                    {post.authorEmail && (
                                        <a href={`mailto:${post.authorEmail}`} className="text-primary hover:underline flex items-center gap-2">
                                            <Icon icon="ph:envelope" width={18} height={18} />
                                            {post.authorEmail}
                                        </a>
                                    )}
                                    {post.authorLinkedIn && (
                                        <a href={post.authorLinkedIn} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline flex items-center gap-2">
